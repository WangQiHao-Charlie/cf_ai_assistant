/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1648fe9959e927fdaca15d3f4247cd53)
// Runtime types generated with workerd@1.20251011.0 2025-11-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PlannerAgent" | "CoderAgent" | "OperatorAgent" | "FullStackAgent";
	}
	interface Env {
		SERVER_HOST: "http://127.0.0.1:8787";
		OPENAI_API_KEY: string;
		CF_API_TOKEN: string;
		CF_ACCOUNT_ID: string;
		CFA_PLAN_AGENT: DurableObjectNamespace<import("./src/index").PlannerAgent>;
		CFA_CODE_AGENT: DurableObjectNamespace<import("./src/index").CoderAgent>;
		CFA_OP_AGENT: DurableObjectNamespace<import("./src/index").OperatorAgent>;
		CFA_FULL_AGENT: DurableObjectNamespace<import("./src/index").FullStackAgent>;
		AI: Ai;
		ASSETS: Fetcher;
		BUILD_SITEFLOW: Workflow<Parameters<import("./src/index").BuildSiteFlow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SERVER_HOST" | "OPENAI_API_KEY" | "CF_API_TOKEN" | "CF_ACCOUNT_ID">> {}
}
