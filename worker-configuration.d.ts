/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 64be30beac554230cdd6bd43c6859969)
// Runtime types generated with workerd@1.20251011.0 2025-11-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PlannerAgent";
	}
	interface Env {
		CFA_AGENT: DurableObjectNamespace /* PlannerAgent */;
		AI: Ai;
		ASSETS: Fetcher;
